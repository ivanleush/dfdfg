...
def get_admin_main_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="⚙️ Управление заданиями", callback_data="admin_manage_tasks"),
...
def get_admin_task_creation_keyboard(texts) -> InlineKeyboardMarkup:
    """Клавиатура для отмены создания задания."""
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text=texts.ADMIN_TASK_CANCEL_BUTTON, callback_data="admin_cancel_task_creation")
        ]
    ])
